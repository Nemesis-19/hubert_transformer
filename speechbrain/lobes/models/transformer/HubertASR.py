...
class HubertASR(TransformerInterface):
    ...
    def forward(self, enc_out, src_key_padding_mask, tgt, pad_idx=0):
        """ 
        Arguments
        ----------
        src : torch.Tensor
        ...
        (
            ...
            src_mask,
            tgt_mask,
        ) = self.make_masks(tgt, pad_idx=pad_idx)
    ...
    def make_masks(self, tgt=None, pad_idx=0):
        ...
        return tgt_key_padding_mask, src_mask, tgt_mask
