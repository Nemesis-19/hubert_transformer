...
import sys
import torch
# torch.cuda.set_device(torch.device("cuda:" + str(local_rank)))
import logging
...
class ASR(sb.core.Brain):
    def compute_forward(self, batch, stage):
        ...
        pred = self.modules.HubertASR(enc_out, src_key_padding_mask, tokens_bos, wav_lens, pad_idx=self.hparams.pad_index)
